...
const criticalCss = ":root{--ink:#151124;--surface:#fff;--purple-900:#241144;--header-height:76px}*{box-sizing:border-box}body{margin:0;color:var(--ink);background:var(--surface);font-family:Manrope,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif}.site-header{height:var(--header-height);background:#fff}.hero{min-height:100svh;background:#4a3185}";
const assets = `<style data-home-css>${criticalCss}</style>\n    <link data-home-bundle rel="preload" href="/assets/build/styles.min.css?v=20260911-qa1" as="style" />\n    <link data-home-bundle rel="stylesheet" href="/assets/build/styles.min.css?v=20260911-qa1" />\n    <link data-home-bundle rel="stylesheet" href="/assets/build/content.min.css?v=20260825-9" />`;
