...
const assets = `<style data-home-css>${criticalCss}</style>\n    <link data-home-bundle rel="preload" href="/assets/build/styles.min.css?v=20260825-12" as="style" />\n    <link data-home-bundle rel="stylesheet" href="/assets/build/styles.min.css?v=20260825-12" />\n    <link data-home-bundle rel="stylesheet" href="/assets/build/content.min.css?v=20260825-9" />`;
